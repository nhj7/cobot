...
// Generated 2017. 8. 12 ���� 11:03:29 by Hibernate Tools 5.2.3.Final
 ...
 */
@Entity
@Table(name = "tb_post_market_info", catalog = "cobot_test")
public class TbPostMarketInfo implements java.io.Serializable {
	...
	public TbPostMarketInfo(long siteId, int postId, String author, String permLink, String prodName, Short method,
			...
			String postImgUrl, String prodImgUrl, String cachePostImgUrl, String cacheProdImgUrl, Double dayLimitAmt,
			Double humanLimitAmt, Integer replyCnt, String alarmInfo, Date regDttm, Date modDttm) {
		this.siteId = siteId;
		this.postId = postId;
		this.author = author;
		this.permLink = permLink;

 ...
 */
@Entity
@Table(name = "tb_post_info", catalog = "cobot")
public class TbPostInfo implements java.io.Serializable {
	...
	public TbPostInfo(String siteDvcd, String categoryDvcd, String postDvcd, String postUrl) {
	...
	public TbPostInfo(String siteDvcd, String categoryDvcd, String postDvcd, String arrTagStr, String postAuthor,
			String postUrl, String postTitle, String postBody, String postImgUrl, Date regDttm, Date modDttm) {
		this.siteDvcd = siteDvcd;
		this.categoryDvcd = categoryDvcd;
		this.postDvcd = postDvcd;

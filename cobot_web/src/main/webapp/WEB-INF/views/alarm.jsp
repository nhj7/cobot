...
<body >
  <main>
  	<p>이 알람 기능은 Steemit의 원하는 태그(ex : kr-market)나 작가(아이디)를 등록하여 포스팅 등록 시 알람을 받아볼 수 있는 기능입니다. 
  	해당 서비스는 안드로이드 브라우저나 크롬 브라우저에서 서비스 가능하며  동의하시는 분은 'Cobot 알람 받기'를 터치해주면 됩니다.
  	IOS는 별도의 계정 구입이 필요해 차후 추가할 예정입니다.
  	</p>
    <p>
    ...
    <p>    
    	...
    	<script>
    	    ...
    	    function getAlarmInfo(){
    	    	//alert(JSON.stringify(gAlarmJson));
    	    	var alarmJson = gAlarmJson;
